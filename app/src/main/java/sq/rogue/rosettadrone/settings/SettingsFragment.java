...
import static sq.rogue.rosettadrone.util.TYPE_MQTT_HOST;
import static sq.rogue.rosettadrone.util.TYPE_MQTT_TOPIC;
    ...
    public void setListeners() {
        ...
        findPreference("pref_mqtt_hosturl").setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                NotificationHandler.notifyAlert(SettingsFragment.this.getActivity(), TYPE_MQTT_HOST,
                        null, null);
                return false;
            }
        });
        findPreference("pref_mqtt_topicdef").setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                NotificationHandler.notifyAlert(SettingsFragment.this.getActivity(), TYPE_MQTT_TOPIC,
                        null, null);
                return false;
            }
        });

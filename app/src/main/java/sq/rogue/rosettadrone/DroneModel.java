...
import static com.MAVLink.common.msg_global_position_int.MAVLINK_MSG_ID_GLOBAL_POSITION_INT;
...
//                parent.logMessageToGCS(msg.toString());
        ...
        // Kari: MQTT Hook here
        if (parent.mMQTTclient != null)
        {
            if (msg.msgid == MAVLINK_MSG_ID_GLOBAL_POSITION_INT || msg.msgid == MAVLINK_MSG_ID_HEARTBEAT)
            parent.mMQTTclient.publish(msg.pack().encodePacket(), parent.mMQTTclient);
        }
    }
